...
const categories = [
  { id: 'trending', label: 'Trending', isActive: true },
  { id: 'business', label: 'Business', isActive: false },
  { id: 'social-media', label: 'Social Media', isActive: false },
  { id: 'education', label: 'Education', isActive: false },
  { id: 'design', label: 'Design', isActive: false },
  { id: 'knowledge-base', label: 'Knowledge Base', isActive: false },
